...
$dsn='mysql:host=codefirst.iut.uca.fr/containers/mariadb-axelde_la_fuente;port=3306;dbname='.getenv("MARIADB_DATABASE");
//$dsn='uri:https://codefirst.iut.uca.fr/containers/mariadb-axelde_la_fuente;';
